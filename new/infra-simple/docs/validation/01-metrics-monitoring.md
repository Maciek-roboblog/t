...
> **Diagram:** Zobacz [training-metrics.puml](diagrams/training-metrics.puml) - wzorce training/validation loss.
...
> **Diagram:** Zobacz [training-metrics.puml](diagrams/training-metrics.puml) - wzorce overfittingu i underfittingu.
...
> **Diagram:** Zobacz [mlflow-integration.puml](diagrams/mlflow-integration.puml) - pełna architektura integracji MLflow.
